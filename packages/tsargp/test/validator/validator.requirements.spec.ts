  ...
  describe('validate', () => {
    describe('validating forward requirements', () => {
      ...
      it('throw an error on option required by itself with req.not', () => {
        ...
        const validator = new OptionValidator(options);
        expect(validator.validate()).rejects.toThrow(`Option flag requires itself.`);
      });
      ...
      it('throw an error on unknown option required with req.one', () => {
        ...
        const validator = new OptionValidator(options);
        expect(validator.validate()).rejects.toThrow(`Unknown option other in requirement.`);
      });
      ...
      it('throw an error on help option required with undefined', () => {
        ...
        const validator = new OptionValidator(options);
        expect(validator.validate()).rejects.toThrow(`Invalid option help in requirement.`);
      });
      ...
      it('throw an error on version option required with null', () => {
        ...
        const validator = new OptionValidator(options);
        expect(validator.validate()).rejects.toThrow(`Invalid option version in requirement.`);
      });
