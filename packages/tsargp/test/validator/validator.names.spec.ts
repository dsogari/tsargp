...
describe('OptionValidator', () => {
  describe('validate', () => {
    ...
    it('return a warning on mixed naming conventions in a nested command', async () => {
      const options = {
        command: {
          type: 'command',
          options: {
    ...
    it('return a warning on option name too similar to other names in a nested command', async () => {
      const options = {
        command: {
          type: 'command',
          options: {
