...
[0;1mUsage:[0m
  ...
  [0mdemo.js hello [0m[90m[...][0m [([35m-h[0m|[35m--help[0m)[0m] [[35mhello[0m [90m...[0m]

[0;1mArguments:[0m

  [90m[...]  [0mAccepts multiple parameters.[0m Reads data from standard input.[0m Defaults to [[32m'world'[0m].[0m
