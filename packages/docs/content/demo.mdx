...
2. check if all arguments after `--` are recognized as positional (e.g., `-- -f`)
...
- check if cluster arguments can be specified with inline parameters (e.g., `-s1 -n-1`, same as above)
...
3. check if a number parameter matches the required range (e.g., try `-nr -3` and see that it fails)
...
[1mUsage:[0m
  [39mdemo.js[0m [[39m([35m-f[0m[39m|[35m--no-flag[0m[39m)][0m
...
[1mUsage:[0m
  ...
  [39mdemo.js[0m [[39m[90m<param>...[0m[39m] [([35m-h[0m[39m|[35m--help[0m[39m)] [[35mhello[0m[39m [90m...[0m[39m][0m

[1mArguments:[0m

  [39m[90m<param>...[0m[39m              [39mAccepts multiple parameters. Accepts positional arguments. Reads data from
                          standard input. Defaults to [[32m'world'[0m[39m].[0m
...
[1mUsage:[0m
  ...
  [39mdemo.js[0m [[39m([35m-h[0m[39m|[35m--help[0m[39m)][0m

[1mOptions:[0m

  [39m[35m-h[0m[39m, [35m--help[0m[39m    [39m[39mThe help option for the hello command. Prints this help message. Uses the remaining
...
3. check if the `-b` option can be specified in combination with required options (e.g. `-b yes -sc one`)
