...
<Callout type="default">
  ...
  keys to navigate the history. For a full experience, you may want to try it in a local bash: ```sh
  copy npm i -g tsargp && complete -C tsargp tsargp ```
</Callout>
...
With the browser console still open, slide the screen splitter until the terminal width changes,
then run the help option again and:
