...
Let's define a reusable option definition for the parameters of a multi-argument operation. It has
an [array] option that receives (unlimited) positional arguments:
