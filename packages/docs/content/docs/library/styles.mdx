...
To preserve previous styles for a particular element, you can assign it an empty `style(){:ts}`. Do the same for all elements if you need to disable styling for your application as a whole (regardless of environment configuration).
