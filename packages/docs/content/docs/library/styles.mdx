...
In addition to predefined colors, there are six utility functions to get custom colors:

- `fg8` - creates an 8-bit foreground color
- `bg8` - creates an 8-bit background color
- `ul8` - creates an 8-bit underline color
- `fg24` - creates a 24-bit RGB foreground color
- `bg24` - creates a 24-bit RGB background color
- `ul24` - creates a 24-bit RGB underline color
...
You can also set an empty `style(){:ts}`, to preserve previous styles for a particular element, or for all elements if you need to disable text styling for your application.
