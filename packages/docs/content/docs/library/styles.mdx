...
The `ErrorMessage` class is a specialization of the warning message, used for errors. It can be instantiated with one of the [error phrases] or with a _custom_ phrase, and should be printed with `console.error{:ts}` or equivalent.
