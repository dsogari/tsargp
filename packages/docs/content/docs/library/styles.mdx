...
| `disallowedInlineParameter`  | An option is supplied with an inline parameter, despite it being disallowed | `'(Option\|Positional marker) #0 does not accept inline parameters.'{:ts}`                       | `#0` = the supplied option name or positional marker                                          |
...
| `missingInlineParameter`     | An option is supplied with no inline parameter, despite it being required   | `'Option #0 requires an inline parameter.'{:ts}`                                                 | `#0` = the supplied option name                                                               |
