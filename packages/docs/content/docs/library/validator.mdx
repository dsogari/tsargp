...
The messages produced by the validator can be customized via a [message configuration], which can be provided as the second parameter to the validator constructor.
