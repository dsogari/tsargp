...
To validate a set of option definitions, you must call the `validate` function. This function accepts a `ValidationFlags` argument with the following optional properties:
