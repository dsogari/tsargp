...
The error and warning messages produced by the validator can be configured via the [message configuration], which can be provided as the second parameter to the validator constructor.
