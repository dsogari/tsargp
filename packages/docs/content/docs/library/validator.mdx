...
The `OptionValidator` component handles validation of option definitions. It can be instantiated
with a set of option _definitions_ and provides a single method to perform the validation.
