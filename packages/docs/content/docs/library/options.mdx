...
In its definition, an option may declare _requirements_, which are specifications of inter-dependencies between options and/or option values in the same definition level.
