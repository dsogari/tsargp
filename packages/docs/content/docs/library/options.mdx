...
The `example` attribute, if present, specifies a value to display in place of option parameter(s) in a help message. It will appear in the [parameter column] and, when a [parameter name] is not present, in the [usage statement] as well.
...
The `paramName` attribute, if present, specifies a name to to display in place of option parameter(s) in a help message. It will appear in the [usage statement] and, when an [example value] is not present, in the [parameter column] as well.

#### Usage parameter name

The `usageParamName` attribute, if present, overrides the [parameter name] in a [usage statement]. It does not appear in the [parameter column].

> [!NOTE]
>
> Mutually exclusive with [example value]. When the latter is present, use [parameter name] instead.
...
This option has the following sets of attributes: [basic], [value], [template] and the attributes described below.
...
This option has the following sets of attributes: [basic], [value], [environment], [template], [parameter], [selection] and the attributes described below.
...
This option has the following sets of attributes: [basic], [value], [environment], [template], [parameter] and the attributes described below.
