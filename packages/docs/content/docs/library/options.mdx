...
- `false{:ts}` to disallow inline parameters
- `'always'{:ts}` to _always_ require inline parameters
- a mapping of option names to one of the above, indicating the constraint for specific names
