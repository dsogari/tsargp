...
| Highly configurable  | Value constraints      | Man pages (in roadmap)  |
| Browser-compatible   | Name suggestions       | [SGR] colors and styles |
| 30KB minified        | Subcommands            | Option grouping/hiding  |
| ESM-native           | Asynchronous callbacks | Custom help sections    |
| Online documentation | GNU's _short-options_  | Usage strings           |
