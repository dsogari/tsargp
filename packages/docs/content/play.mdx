...
export const initialDoc = `const {
  ArgumentParser, HelpItem, ParsingError, ValidationError, ConnectiveWord,
  req, tf, fg, bg, ul, style, fg8, bg8, ul8,
} = tsargp;

return { // Define your options here. Only plain JavaScript is allowed. help: { type: 'help', names: ['-h', '--help'], synopsis: \`Prints this \${style(tf.italic)}help\${style(tf.clear)} message.\`, }, };`;
