...
export const initialDoc = `const {ErrorItem, HelpItem, config, req, tf, fg, bg, ul, style, fg8, bg8, ul8} = tsargp;
...
<Code callbacks={callbacks} initialDoc={initialDoc} initialSel={[100]} />
